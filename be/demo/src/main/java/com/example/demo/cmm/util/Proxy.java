...
public class Proxy {
	...
	public static Function<Integer, Integer> rangYearRandom = (t) -> ((int)(Math.random() * t) + 1990); 
	public static Function<Integer, Integer> rangMonthRandom = (t) -> ((int)(Math.random() * t) + 1); 

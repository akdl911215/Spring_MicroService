...
public class DummyGenerator {
	 ...
	 * 
	 * 윤년은 해당 연도를 4로 나눈 값이 0인 것을 의미한다. && 그중 100으로 나눈 값이 0인 것은 윤년에서 제외하나, || 400으로
	 * 나눈 값이 0인 것은 윤년으로 포함된다. 그 외의 나머지 연도는 평년이다.
	 */

	public String makeBirthday() {

		return myCalendar(1970, 2000);

	}

	public String myCalendar(int start, int end) {
	...
	public User makeUser() {
		return new User(makeName(), "1", makeUsername(), makeEmail(), makeGender(), makeBirthday(), makeRegdate());
	}
}
